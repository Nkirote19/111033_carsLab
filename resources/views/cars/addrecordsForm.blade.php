...
<body>
 ...
 <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="col-xl-6" style="margin-top: 5%!important;">
            ...
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>ADD <span class="fw-300"><i>New Car</i></span></h2>
                </div>

                <div class="panel-container show">
                    <div class="panel-content">

                        <form id="add-car-form" method="POST" data-type="json" action="/register_car"enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">                 
                                <div class="form-group col-4">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        <input id="make" name="make" type="text" class="form-control"aria-label="Make" aria-describedby="addon-wrapping-right" data-toggle="tooltip" data-placement="top"   data-original-title="Please Enter Car's Make">

                                        <div class="input-group-append">
                                            <span class="input-group-text"><i class="fas fa-car fs-xl"></i></span>
                                        </div>
                                    </div>
                                    </section>
                                </div>
                                ...
                                <div class="form-group col-4">
                                    <section >
                                        ...
                                        <div class="input-group flex-nowrap">
                                            <input id="model" name="model" type="text" class="form-control"aria-label="model" aria-describedby="addon-wrapping-right" data-toggle="tooltip" data-placement="top"   data-original-title="Please Enter Car's Model">
                                 ...
                                 <div class="form-group col-4">
                                    <section >
                                        <label class="form-label" for="produced_on">Produced on</label>
                                        <div class="input-group flex-nowrap">
                                            <input id="produced_on" name="produced_on" type="date" class="form-control"aria-label="produced_on" aria-describedby="addon-wrapping-right" data-toggle="tooltip" data-placement="top"   data-original-title="Please Enter Car's Production Date">

                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="fas fa-calendar-alt fs-xl"></i></span>
                                            </div>
                                        </div>
                                    </section>
                                </div>                              
							...
							<div class="card-footer text-muted">                                     
                                <div style="text-align: right;">
                                    <button id="add_car_submit" type="submit" class="btn btn-primary "><i class="fas fa-plus fs-xl"></i> Add Car</button>
                                </div>
                            </div>
 ...
 <footer class="page-footer" role="contentinfo"style="background-color: transparent!important;">
                        <div class="d-flex  flex-1 ">
                            <div class="hidden-md-down fw-700" style="margin-left: 46%;margin-top: 16%;">2020 ©Nkirote</div>
                        </div>                      
                    </footer>
</body>
